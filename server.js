...
const bookingRoutes = require('./booking'); // Assuming this path is correct
...
// ✅ API routes for bookings - FIX IS HERE!
app.use('/api/bookings', bookingRoutes); // Changed from '/bookings' to '/api/bookings'
